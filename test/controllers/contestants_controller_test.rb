...
class ContestantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contestant" do
    assert_difference('Contestant.count') do
      post contestants_url, params: { contestant: { con_num: @contestant.con_num, image: @contestant.image, name: @contestant.name, profile: @contestant.profile } }
    end
  ...
  test "should update contestant" do
    patch contestant_url(@contestant), params: { contestant: { con_num: @contestant.con_num, image: @contestant.image, name: @contestant.name, profile: @contestant.profile } }
